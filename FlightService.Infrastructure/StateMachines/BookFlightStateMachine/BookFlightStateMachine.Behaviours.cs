...
public partial class BookFlightStateMachine
{
    private void SetupBehaviours()
    {
        Initially(When(CreateBookFlight)
            ...
            When(CancelBookFlight).ThenAsync(context =>
                {
        ...
        During(Pending,
            When(CompleteBookFlight).Unschedule(BookFlightExpiredSchedule)
                .ThenAsync(context =>
                {
                ...
                .Finalize(),
            When(CancelBookFlight).Unschedule(BookFlightExpiredSchedule)
                .ThenAsync(context =>
                {
            ...
            When(ExpireBookFlight).ThenAsync(context =>
            {
